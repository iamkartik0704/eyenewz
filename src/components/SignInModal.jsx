...
function SignInModal({ isOpen, onClose }) {
  ...
  return (
    <div className="modal" id="signin-modal">
      ...
      <div className="modal-card" role="dialog" aria-modal="true" aria-labelledby="signin-title">
        ...
        <p className="modal-legal">
          By continuing, you agree to EyeNewz
        ...
        <p className="modal-note">
          Sign-in lives in the EyeNewz Android app for now. Tap above to open Google Play —
          web Google Sign-In is coming next.
        </p>
      </div>
    </div>
  );
